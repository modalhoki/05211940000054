    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-6 d-lg-flex flex-lg-column align-items-stretch order-1 order-lg-2 hero-img" data-aos="fade-up">
          <img class= "il-1 img-fluid" src='assets/img/CewekRoket.svg' alt="GAS">
        </div>
      </div>
    </div>
      ...
      <div class="container">
        ...
        <div class="row content">
          <div class="col-md-4" data-aos="fade-right">
            <img src="assets/img/CewekMotor.svg" class="img-fluid" alt="">
          </div>
      ...
      <div class="container">
        ...
        <div class="row no-gutters">
          ...
          <div class="col-lg-4 box" data-aos="fade-right">
            <h3>Mo-bil</h3>
            <img src="assets/img/Mo-bil.svg" width="150px" alt="Mo-bil" class="">
            <ul class="mt-4">
          ...
          <div class="col-lg-4 box featured" data-aos="fade-up">
            <h3>Mo-tor</h3>
            <img src="assets/img/Mo-tor.svg" width="150px" alt="Mo-tor">
            <ul class="mt-4">
              <p style="line-height:30px;">
          ...
          <div class="col-lg-4 box" data-aos="fade-left">
            <h3>Ma-kan</h3>
            <img src="assets/img/Ma-kan.svg" width="150px" alt="Ma-kan">
            <ul class="mt-4">
              <p style="line-height: 30px;">
          ...
          <div class="col-md-12">
              <div id="news-slider" class="owl-carousel">
                  <div class="post-slide">
                      <div class="post-img">
                          <img src="assets/img/Gambar-jakarta.jpg" alt="">
                  ...
                  <div class="post-slide">
                      <div class="post-img">
                          <img src="assets/img/Gambar-perahu.jpg" alt="">
                  ...
                  <div class="post-slide">
                    <div class="post-img">
                        <img src="assets/img/Gambar-tani.jpg" alt="">
                ...
                <div class="post-slide">
                  <div class="post-img">
                      <img src="assets/img/Gambar-pasar.jpg" alt="">
                      <div class="category">EKO</div>
                  </div>
                  <div class="post-review">
